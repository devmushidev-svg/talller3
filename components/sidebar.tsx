    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-3 px-6 py-6 border-b border-sidebar-border">
          ...
          <div>
            <h1 className="font-semibold text-sm leading-tight">Sistema de Tickets</h1>
            <p className="text-xs text-sidebar-foreground/60">de Taller</p>
          </div>
        </div>
